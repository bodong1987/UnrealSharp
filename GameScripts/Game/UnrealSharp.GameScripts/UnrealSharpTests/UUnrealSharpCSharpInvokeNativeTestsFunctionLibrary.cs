...
namespace UnrealSharp.GameScripts.UnrealSharpTests
{
    ...
    public class UUnrealSharpCSharpInvokeNativeTestsFunctionLibrary : UBlueprintFunctionLibrary
    {
        ...
        {
            string checkResult = $"{callerName} [{number}]:{(result ? "Success" : "Failure")}";
        ...
        private static void CheckObjectPropertyAccess_Bool()
        {
            ...
            bool result = UUnrealSharpTestsFunctionLibraryInCpp.CppAddAndReturnByRef_Bool(a, b, ref oa, ref ob);
            CheckResult(!result);
            CheckResult(a == oa);
            CheckResult(b == ob);
        ...
        {
            byte a = (byte)random.Next(byte.MaxValue);
            byte b = (byte)random.Next(byte.MaxValue);
            byte oa = 0;
            byte ob = 0;

            byte result = UUnrealSharpTestsFunctionLibraryInCpp.CppAddAndReturnByRef_UInt8(a, b, ref oa, ref ob);
        ...
        private static void CheckObjectPropertyAccess_Int32()
        {
            ...
            int result = UUnrealSharpTestsFunctionLibraryInCpp.CppAddAndReturnByRef_Int32(a, b, ref oa, ref ob);
        ...
        private static void CheckObjectPropertyAccess_Float()
        {
            ...
            float result = UUnrealSharpTestsFunctionLibraryInCpp.CppAddAndReturnByRef_Float(a, b, ref oa, ref ob);
        ...
        private static void CheckObjectPropertyAccess_Double()
        {
            ...
            double result = UUnrealSharpTestsFunctionLibraryInCpp.CppAddAndReturnByRef_Double(a, b, ref oa, ref ob);
        ...
        {
            List<string> testStrings = new List<string> { "Hello", "World", "你好", "世界", "こんにちは", "世界" };
        ...
        {
            TSubclassOf<UUnrealSharpTestsBaseObjectInCpp> a = UClass.GetTSubClassOf<UUnrealSharpTestsBaseObjectInCpp>();
            TSubclassOf<UUnrealSharpTestsBaseObjectInCpp> b = new TSubclassOf<UUnrealSharpTestsBaseObjectInCpp>(UUnrealSharpTestsObjectInCpp.StaticClass());
        ...
        {
            CheckResult(csObject.bBoolValueInCpp == true);
            csObject.bBoolValueInCpp = false;
            CheckResult(csObject.bBoolValueInCpp == false);

            CheckResult(csObject.bBoolBitMaskInCpp0 == true);
            CheckResult(csObject.bBoolBitMaskInCpp1 == false);
            CheckResult(csObject.bBoolBitMaskInCpp2 == true);
            ...
            CheckResult(csObject.bBoolBitMaskInCpp1 == true);
            CheckResult(csObject.bBoolBitMaskInCpp2 == false);
            CheckResult(csObject.bBoolBitMaskInCpp3 == true);

            CheckResult(csObject.bBoolValueInCSharp == true);
        ...
        private static void CheckObjectPropertyAccess_BaseTestBaseStructInCSharp(UUnrealSharpTestsObjectInheritCPPObjectInCSharp csObject)
        {
            ...
            CheckResult(structValue.bBoolValue == true);
        ...
        private static void CheckObjectPropertyAccess_CSharpTestBaseStructInCSharp(UUnrealSharpTestsObjectInheritCPPObjectInCSharp csObject)
        {
            ...
            CheckResult(structValue.bBoolValueDefByProperty == true);
        ...
        private static void CheckObjectPropertyAccess_ObjectArray(UUnrealSharpTestsObjectInheritCPPObjectInCSharp csObject)
        {
            ...
            if (CheckResult(cppArray != null))
            {
                ...
                // Test Indexer
                CheckResult(cppArray[0] == baseObject1);
                CheckResult(cppArray[1] == object1);
                ...
                CheckResult(cppArray.Count == 3);
                CheckResult(cppArray[1] == baseObject2);
                ...
                CheckResult(cppArray.Count == 2);
                CheckResult(cppArray[0] == objectArray[0]);
        ...
        private static void CheckObjectPropertyAccess_FloatSet(UUnrealSharpTestsObjectInheritCPPObjectInCSharp csObject)
        {
            ...
            var testData = new float[] { 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f };
        ...
        private static void CheckObjectPropertyAccess_StringSet(UUnrealSharpTestsObjectInheritCPPObjectInCSharp csObject)
        {
            ...
            var testData = new string[] { "Hello", "Bonjour", "Hola", "你好", "こんにちは", "안녕하세요", "Guten Tag", "Ciao", "Olá", "Здравствуйте" };
        ...
        private static void CheckObjectDelegate(UUnrealSharpTestsObjectInheritCPPObjectInCSharp csObject)
        {
            ...
            bool bParam = true;
            int iParam = 1024;
            string sParam = "Hello, UnrealSharp!!! 你好，虚幻！！！";

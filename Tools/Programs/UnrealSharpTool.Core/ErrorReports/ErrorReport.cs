...
/// </summary>
public readonly struct TypeDefinitionSourceInfo
{
    /// <summary>
    /// The signature
    /// </summary>
...
public static class ErrorReport
{
    ...
    {
        var text = BuildReportString("warning", warningCode.ToString(), message, sourceInfo);
    ...
    {
        var si = new TypeDefinitionSourceInfo(identifier, debugInformation);
    ...
    {
        var text = BuildReportString("error", errorCode.ToString(), message, sourceInfo);
    ...
    public static string BuildReportString(string category, string code, string message, TypeDefinitionSourceInfo sourceInfo)
    {
        ...
        if (sourceInfo.SourceInfos != null && sourceInfo.SourceInfos.Any())
        {

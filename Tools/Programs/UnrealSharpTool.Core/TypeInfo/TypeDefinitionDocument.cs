...
public class TypeDefinitionDocument
{
    ...
    /// </summary>
    [JsonIgnore]
    public readonly Dictionary<string, BaseTypeDefinition> NameMapping = new();
    ...
    [JsonIgnore]
    public Version UnrealEngineVersion => new(UnrealMajorVersion, UnrealMinorVersion, UnrealPatchVersion);
    #endregion
    ...
    public bool IsFastInvokeIgnore(string className, string methodName)
    {
            ...
            return FastFunctionInvokeIgnoreNames.Contains(key);
    }
    ...
    {
            NameMapping.TryGetValue(cppName, out var type);
            return type;
        }
    ...
    public static ulong CalcTypeDefinitionCrcCode(BaseTypeDefinition typeDefinition)
    {
            var jsonString = JsonConvert.SerializeObject(typeDefinition, Formatting.Indented, GetDefaultJsonSerializerSettings());
    ...
    private class CustomOrderContractResolver : DefaultContractResolver
    {
        /// <summary>
    ...
    {
            var jsonString = JsonConvert.SerializeObject(this, Formatting.Indented, GetDefaultJsonSerializerSettings());
    ...
    {
            var roslynDebugInformation = new RoslynDebugInformation(sourceFiles);

            switch (bindingCodeGenerateSourceType)
            {
                case BindingCodeGenerateSourceType.CSharpCode:
                    return RoslynTypeDefinitionDocumentFactory.ParseFromDirectory(inputSource, globalOptions, roslynDebugInformation);
                case BindingCodeGenerateSourceType.Assembly:
                    return MonoTypeDefinitionDocumentFactory.LoadFromAssemblies(
            ...
            return !document.LoadFromFile(inputSource) ? null : document;
        }
    #endregion
}
...
public class FunctionTypeDefinition : StructTypeDefinition
{
    ...
    [JsonIgnore]
    public bool IsStatic => (Flags & (uint)EFunctionFlags.Static) != 0;
    ...
    [JsonIgnore]
    public bool IsPublic => (Flags & (uint)EFunctionFlags.Public) != 0;
    ...
    [JsonIgnore]
    public bool IsProtected => (Flags & (uint)EFunctionFlags.Protected) != 0;
    ...
    [JsonIgnore]
    public bool IsPrivate => (Flags & (uint)EFunctionFlags.Private) != 0;
    ...
    [JsonIgnore]
    public bool IsFinal => (Flags & (uint)EFunctionFlags.Final) != 0;
    ...
    [JsonIgnore]
    public bool IsEvent => (Flags & (uint)EFunctionFlags.BlueprintEvent) != 0;

...
namespace UnrealSharpTool.Core.Utils
{
    ...
    public class AssemblySearchOptions : ITypeDefinitionDocumentInitializeOptions
    {
        ...
        public EConfigurationType ConfigurationType { get; set; } = EConfigurationType.Debug;
        ...
        public EArchitectureType ArchitectureType { get; set; } = EArchitectureType.X64;
        ...
        /// </summary>
        public readonly List<string> CustomSearchDirectories = new List<string>();

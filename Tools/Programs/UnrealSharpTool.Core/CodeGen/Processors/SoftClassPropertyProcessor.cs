...
namespace UnrealSharpTool.Core.CodeGen.Processors
{
    ...
    class SoftClassPropertyProcessor : PropertyProcessor
    {
        /// <summary>
        ...
        public string GetElementTypeName(PropertyDefinition property)
        {
            ...
            if (!property.CppTypeName!.StartsWith("TSoftClassPtr<"))
            {
                return property.GetCSharpTypeName(Context, ELocalUsageScenarioType.GenericArgument);
            }

            return property.CppTypeName!.Trim().Substring("TSoftClassPtr<".Length).Trim('<', '>', ' ');
        }
        ...
        public override string GetCSharpTypeName(PropertyDefinition property, ELocalUsageScenarioType usage)
        {
            if (property.CppTypeName == "TSoftClassPtr`1")
            {
                ...
                {
                    return $"TSoftClassPtr<{GetElementTypeName(property)}>";
                }

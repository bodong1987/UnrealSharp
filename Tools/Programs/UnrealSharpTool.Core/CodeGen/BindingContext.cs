...
namespace UnrealSharpTool.Core.CodeGen
{
    ...
    public class BindingContext
    {
        ...
        /// The importer
        /// </summary>
        private PropertyProcessorImporter Importer;
        ...
        /// </summary>
        public readonly Dictionary<string, List<BaseTypeDefinition>> ProjectTypeMapping = new Dictionary<string, List<BaseTypeDefinition>>();

        /// <summary>
        /// The fast invoke functions
        /// </summary>
        public readonly HashSet<FunctionTypeDefinition> FastInvokeFunctions = new HashSet<FunctionTypeDefinition>();
        ...
        public Version UnrealVersion { get; private set; }
        ...
        private BindingContext(TypeDefinitionDocument document, string projectDirectory, EBindingSchemaType schemaType)
        {
            ...
            foreach (var type in document.Types)
            {
                ...
                if (!ProjectTypeMapping.TryGetValue(projectName, out List<BaseTypeDefinition>? definitions))
                {
            ...
            Importer = new PropertyProcessorImporter(this);
        }
        ...
        {
            return Importer.GetProcessor(propertyDefinition);
        }

namespace UnrealSharp.Utils.UnrealEngine
{
    ...
    public class UPROPERTYAttribute : UUnrealAttribute<EPropertyFlags>
    {
        ...
        /// <summary>
        /// set the attach target component name.
        ...
        /// </summary>
        /// <value>The attach to component.</value>
        public string? AttachToComponentName { get; set; }

        /// <summary>
        /// Gets or sets the name of the attach to socket.
        /// </summary>
        /// <value>The name of the attach to socket.</value>

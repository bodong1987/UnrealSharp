...
public class UMETAAttribute : Attribute
{
    ...
    public UMETAAttribute(string name, bool value) : this(name, value.ToString())
    {
    }
    ...
    /// <param name="value">The value.</param>
    // ReSharper disable once UnusedMember.Global
    public UMETAAttribute(string name, int value) : this(name, value.ToString())
    {
    }
}
...
public static class MetaConstants
{
    ...
    /// <summary>
    /// don't use generic spawn object
    /// </summary>
